...
START_TEST(only_ints) {
  int64_t a1 = 0, a2 = 0, b1 = 0, b2 = 0, c1 = 0, c2 = 0, d1 = 0, d2 = 0;
...
START_TEST(ints_astwidth) {
  int64_t a1 = 0, a2 = 0, b1 = 0, b2 = 0, c1 = 0, c2 = 0;
...
START_TEST(strings_mixed) {
  uint64_t a1 = 0, a2 = 0, b1 = 0, b2 = 0, c1 = 0, c2 = 0;
  int64_t d1 = 0, d2 = 0;
...
START_TEST(last_double) {
  double a1 = 0, a2 = 0, b1 = 0, b2 = 0, c1 = 0, c2 = 0;
  const char str[] =
      "double: 3.14159265358979323846, double: 2.718282e+41, double: "
      "1.442695E+27";
  const char fstr[] = "double: %lf, double: %le, double: %lE";
...
START_TEST(check_n2) {
  ...
  ret1 = s21_sscanf("42", "%d%n", &d1, &n1);
  ret2 = sscanf("42", "%d%n", &d2, &n2);
...
Suite *suite_sscanf(void) {
  ...
  tcase_add_test(tc, only_ints);
  tcase_add_test(tc, ints_nwidth);
  tcase_add_test(tc, ints_astwidth);
  tcase_add_test(tc, spec_i_int);
  tcase_add_test(tc, spec_i_oct);
  tcase_add_test(tc, spec_i_hex);
  tcase_add_test(tc, strings);
  tcase_add_test(tc, unint);
  tcase_add_test(tc, strings_mixed);
  tcase_add_test(tc, floats);
  tcase_add_test(tc, floats_sci);
  tcase_add_test(tc, n1);
  tcase_add_test(tc, octal_base_version);
  tcase_add_test(tc, pointer);
  tcase_add_test(tc, buff);
  tcase_add_test(tc, perc);
  tcase_add_test(tc, mixed_ptrs);
  tcase_add_test(tc, hard);
  tcase_add_test(tc, last_double);
  tcase_add_test(tc, check_n2);
