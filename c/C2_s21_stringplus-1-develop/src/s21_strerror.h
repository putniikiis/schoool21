...
const char* errors[size_errors] {
  ...
  [14] = "Bad address", [15] = "Block device required", [16] = "Resource busy",
  ...
  [86] = "Bad CPU type in executable", [87] = "Shared library version mismatch",
